    ...
    <div className="w-full bg-white shadow-lg rounded-lg p-4 h-full flex flex-col">
          ...
          {productos.map((producto) => (
            <div key={producto.id} className="border rounded-lg p-4">
              ...
              <div className="flex justify-center space-x-1 mt-4">
                <BotonEditar onEditar={() => setProductoEditando(producto)} />
                <BotonEliminar onEliminar={() => handleEliminar(producto.id)} />
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="mt-2 flex justify-center space-x-2">
        ...
        <span className="px-4 py-2">
          ...
          {Math.ceil(totalProductos / productosPerPage)}
        </span>
        <button
          onClick={() =>
          ...
          disabled={
            paginaActual >= Math.ceil(totalProductos / productosPerPage)
          }
          className="px-4 py-2 border rounded-md disabled:opacity-50"
        >
          Siguiente
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            ...
            >
              ...
              <div>
                ...
                <select
                  value={
                    productoEditando.disponible ? "disponible" : "no_disponible"
                  }
                  onChange={(e) =>
                    setProductoEditando({
                      ...productoEditando,
